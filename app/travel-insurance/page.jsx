        ...
        <div className="container">
          <div className="ti-hero-grid">
            ...
            <div className="ti-hero-content reveal">
              ...
              {/* Trust Pill Row */}
              <div className="ti-hero-trust-row">
                <div className="ti-trust-pill">
                  <svg width="15" height="15" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" aria-hidden="true">
                    <path d="M12 22s8-4 8-10V5l-8-3-8 3v7c0 6 8 10 8 10z" />
                    <polyline points="9 12 11 14 15 10" />
                  </svg>
                  <span>Visa-compliant coverage</span>
                </div>
                <div className="ti-trust-pill">
                  <svg width="15" height="15" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" aria-hidden="true">
                  ...
                  <span>Worldwide emergency network</span>
                </div>
                <div className="ti-trust-pill">
                  <svg width="15" height="15" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" aria-hidden="true">
                    <polygon points="13 2 3 14 12 14 11 22 21 10 12 10 13 2" />
                  </svg>
                  <span>Prompt policy issuance</span>
                </div>
              </div>
            </div>
